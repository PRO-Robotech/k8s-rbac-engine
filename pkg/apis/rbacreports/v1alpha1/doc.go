...
// `controller-gen object` from the +kubebuilder:object markers in
// types.go. CRD YAML manifests in deploy/kustomize/base/crds/ are
// produced by `controller-gen crd` from the +kubebuilder:resource and
