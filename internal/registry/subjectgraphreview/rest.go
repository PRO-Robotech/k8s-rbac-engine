...
// NewREST returns a REST handler for subjectgraphreviews.
...
func (r *REST) New() runtime.Object { return &rbacgraph.SubjectGraphReview{} }

func (r *REST) Destroy() {}

func (r *REST) NamespaceScoped() bool { return false }

func (r *REST) GetSingularName() string { return "subjectgraphreview" }
...
func (r *REST) Create(ctx context.Context, obj runtime.Object, _ rest.ValidateObjectFunc, _ *metav1.CreateOptions) (runtime.Object, error) {
	review, ok := obj.(*rbacgraph.SubjectGraphReview)
	if !ok {
	...
	review.Status = r.engine.QuerySubjectGraph(snapshot, review.Spec, r.indexer.DiscoveryCache())
